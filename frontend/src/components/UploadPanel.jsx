...
export default function UploadPanel({ documents, onUpload, onDelete }) {
  ...
  return (
    <div className="flex-1 flex flex-col p-4 overflow-hidden" style={{ background: "#fafbff" }}>
      ...
      <div
        ...
        style={{
          border: dragOver ? "1.5px dashed #4338ca" : "1.5px dashed #c7d0f0",
          background: dragOver ? "#eef1fc" : "#f4f7ff",
      ...
      >
        ...
        {uploading ? (
          <div className="flex flex-col items-center gap-2 py-1">
            {/* Progress bar */}
            <div className="w-full rounded-full h-1.5 overflow-hidden" style={{ background: "#dde3f5" }}>
              <div
          ...
          <div className="py-1">
            ...
            <p className="text-xs" style={{ color: "#8892c8" }}>PDF · DOCX · TXT · MD · CSV</p>
            <p className="text-xs mt-0.5" style={{ color: "#b0b8d8" }}>Tối đa 10MB</p>
          </div>
        )}
      </div>
      ...
      <div className="flex-1 overflow-y-auto">
        <div className="flex items-center justify-between mb-3">
          <p className="text-xs font-semibold uppercase tracking-widest" style={{ color: "#8892c8", letterSpacing: "0.08em" }}>
            Tài liệu
          </p>
          <span
        ...
        {documents.length === 0 && (
          <div className="text-center py-8">
            ...
            >
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#b0b8d8" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
                <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/>
                <polyline points="14,2 14,8 20,8"/>
              </svg>
            </div>
            <p className="text-xs" style={{ color: "#b0b8d8" }}>Chưa có tài liệu nào</p>
          </div>
        )}
            ...
            <div key={doc.id}>
              {confirmDelete === doc.id ? (
                ...
                >
                  ...
                  <div className="flex gap-2">
                    ...
                    <button
                      ...
                      className="flex-1 text-xs py-1 rounded-lg font-medium transition-all"
                      style={{ background: "#f0f4ff", color: "#4338ca", border: "0.5px solid #dde3f5" }}
                    >
                      Hủy
                    </button>
                  </div>
                ...
                <div
                  ...
                  style={{ background: "#ffffff", border: "0.5px solid #dde3f5" }}
                  onMouseEnter={e => e.currentTarget.style.borderColor = "#a5b4fc"}
                  onMouseLeave={e => e.currentTarget.style.borderColor = "#dde3f5"}
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-xs" style={{ color: "#b0b8d8" }}>
                  ...
                  <button
                    ...
                    onMouseLeave={e => { e.currentTarget.style.color = "#b0b8d8"; e.currentTarget.style.background = "transparent"; }}
                    title="Xóa tài liệu"
                  >
